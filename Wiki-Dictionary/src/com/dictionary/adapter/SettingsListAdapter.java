...
import com.dictionary.aard.pro.ArticleWebView;
...
public class SettingsListAdapter extends BaseAdapter implements SharedPreferences.OnSharedPreferenceChangeListener {
	...
	public final static int CSS_SELECT_REQUEST = 13;
	...
	public Map<String, ?> userStyleData;
	public SharedPreferences userStylePrefs;
	public View.OnClickListener onDeleteUserStyle;
	...
	public final static int POS_CLEAR_CACHE = 4;
	...
	private View getUIThemeSettingsView(View convertView, ViewGroup parent) {
		...
		if (convertView != null) {
			...
			String currentValue = prefs.getString(Application.PREF_UI_THEME, Application.PREF_UI_THEME_LIGHT);
			...
			RadioButton btnLight = (RadioButton) view.findViewById(R.id.setting_ui_theme_light);
			RadioButton btnDark = (RadioButton) view.findViewById(R.id.setting_ui_theme_dark);
		...
		if (convertView != null) {
			...
			btnAdd.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View view) {
					...
					try {
						context.startActivityForResult(chooser, CSS_SELECT_REQUEST);
	...
	private void deleteUserStyle(final String name) {
		...
		new AlertDialog.Builder(context).setIcon(android.R.drawable.ic_dialog_alert).setTitle("").setMessage(message)
	...
	private View getRemoteContentSettingsView(View convertView, ViewGroup parent) {
		...
		if (convertView != null) {
			...
			final SharedPreferences prefs = view.getContext().getSharedPreferences(ArticleWebView.PREF, Activity.MODE_PRIVATE);
			...
			RadioButton btnAlways = (RadioButton) view.findViewById(R.id.setting_remote_content_always);
			RadioButton btnWiFi = (RadioButton) view.findViewById(R.id.setting_remote_content_wifi);
			RadioButton btnNever = (RadioButton) view.findViewById(R.id.setting_remote_content_never);
