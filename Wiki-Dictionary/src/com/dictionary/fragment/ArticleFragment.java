...
import com.dictionary.aard.pro.R.menu;
import com.dictionary.aard.pro.R.string;
import com.dictionary.aard.pro.R.xml;
...
public class ArticleFragment extends Fragment {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (itemId == R.id.action_select_style) {
			...
			builder.setTitle(R.string.select_style).setItems(styleTitles, new DialogInterface.OnClickListener() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		if (url == null) {
			...
			icon.setImageDrawable(FontIconDrawable.inflate(getActivity(), R.xml.ic_empty_view_not_available));
			return layout;
		}
