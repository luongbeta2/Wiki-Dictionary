...
public abstract class BlobDescriptorListFragment extends BaseListFragment {
	...
	public boolean onSelectionActionItemClicked(final ActionMode mode, MenuItem item) {
		...
		case R.id.blob_descriptor_delete:
			...
			deleteConfirmationDialog = new AlertDialog.Builder(getActivity()).setIcon(android.R.drawable.ic_dialog_alert).setTitle("")
					.setMessage(message).setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
						@Override
